            ...
            if not detected["superleme_path"]:
                try:
                    for root, dirs, files in os.walk(search_root):
                        ...
                        if root.endswith(os.path.join("zotonic", "apps_user", "superleme")):
            ...
            if not detected["sl_phoenix_path"]:
                try:
                    for root, dirs, files in os.walk(search_root):
                        ...
                        if "phoenix" in os.path.basename(root).lower() or os.path.basename(root) == "sl_phoenix":
                        ...
                        if "package.json" in files:
                            try:
                                ...
                                with open(pkg_path, 'r') as f:
                                    ...
                                    is_chrome_extension = (
                                        "plugin" in name.lower() or
                                        ("chrome" in description and "extension" in description) or
                                        "@types/chrome" in dev_deps or
                                        "chrome-types" in dev_deps
                                    )
